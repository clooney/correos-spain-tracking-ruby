...
postData = {"tracking_number":"LP115956271GB"}
tracker = Trackingmore.new()
...
=begin
url="http://api.trackingmore.com/v2/trackings/get?page=1&limit=100&created_at_min=&created_at_max=&update_time_min=&update_time_max=&order_created_time_min=&order_created_time_max=&numbers=LP115956271GB&orders=&lang=en"
postData = ""
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"GET")
puts "Response #{res.code} #{res.message}: #{res.body}"
...
=begin
url="http://api.trackingmore.com/v2/trackings/correos-spain/LP115956271GB/en"
postData = ""
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"GET")
puts "Response #{res.code} #{res.message}: #{res.body}"
...
=begin
url="http://api.trackingmore.com/v2/trackings/correos-spain/LP115956271GB"
...
postData = {"tracking_number": "LP115956271GB","carrier_code":"correos-spain","destination_code": "US","tracking_ship_date":"20180908","tracking_postal_code":"12201","specialNumberDestination":"UK","order":"#123","order_create_time":"2018/09/08 16:51","lang":"en"}
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
...
postData = {"tracking_number":"LP115956271GB","carrier_code":"correos-spain","update_carrier_code":"china-ems"}
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
...
postData = [{"carrier_code":"correos-spain","destination":"US","original":"CN"},{"carrier_code":"china-ems","destination":"US","original":"CN"}]
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
...
postData = [{"tracking_number":"LP115956271GB","carrier_code":"correos-spain"},{"tracking_number":"LZ448865302CN","carrier_code":"china-ems"}]
tracker = Trackingmore.new()
res = tracker.tracker(url,postData,"POST")
puts "Response #{res.code} #{res.message}: #{res.body}"
=end
